...
class AnalogClock:
    ...
    def load_theme(self):
        ...
        # Background
        self.clock_drop_shadow = get_theme('clock-drop-shadow.svg')
        self.clock_face = get_theme('clock-face.svg')
        self.clock_marks = get_theme('clock-marks.svg')

        # Foreground
        self.clock_face_shadow = get_theme('clock-face-shadow.svg')
        self.clock_glass = get_theme('clock-glass.svg')
        self.clock_frame = get_theme('clock-frame.svg')

        # Shadows of hands
        self.clock_hour_hand_shadow = get_theme('clock-hour-hand-shadow.svg')
        self.clock_minute_hand_shadow = get_theme('clock-minute-hand-shadow.svg')
        self.clock_second_hand_shadow = get_theme('clock-second-hand-shadow.svg')

        # Hands
        self.clock_hour_hand = get_theme('clock-hour-hand.svg')
        self.clock_minute_hand = get_theme('clock-minute-hand.svg')
        self.clock_second_hand = get_theme('clock-second-hand.svg')
