...
pattern = re.compile('bornloser\\d+\\.gif')
pattern2 = re.compile('bornloser\\d+\\.jpg')
temp1 = 'http://www.snoopy.com/comics/bornloser/archive/bornloser-%s.html'
temp2 = 'http://www.snoopy.com/comics/bornloser/archive/images/%s'
