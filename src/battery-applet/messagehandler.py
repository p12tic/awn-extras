...
class InvisibleMessageState:
    ...
    def evaluate(self):
        ...
        if self.handler.applet.settings["notify-high-level"] and \
                self.handler.applet.backend.get_capacity_percentage() >= self.handler.applet.settings["level-notify-high"]:
